...
@Entity(
        tableName = "user_planned_meals",
        primaryKeys = {"email", "idMeal", "date"}
)
public class UserPlannedMeal {
    public UserPlannedMeal() {
    ...
    public UserPlannedMeal(
        ...
        this.strMealAlternate = meal.getStrMealAlternate();
